(function() {
  ...
  transit.prototype.getDBConnection = function() {
    var self = this;
    if (this.db != null) {
      return this.db;
    }
  ...
  transit.prototype.onConnected = function() {
  ...
  transit.prototype.buildSchema = function() {
  ...
  transit.prototype.insertData = function() {
    ...
    GTFSfiles.forEach(function(name, index) {
      ...
      fetch(filePathName)
        ...
        .then(function(data) {
          ...
          .catch(function(err) {
            console.log(name+' is created. '+err);
          });
        })
  ...
  transit.prototype.importFromTxtToDB = function(table, data) {
  ...
  transit.prototype.retrieveStops = function() {
  ...
  transit.prototype.searchSchedule = function(departure, arrival) {
    // GTFS Diagram
